...
var game3 = new Game('McIsaac');
var game4 = new Game('Bond');
...
var johnny = new Player('Johnny 5','p4553');
    ...
    // McIsaac
//var matt = new Player('Matt','any');
//var christine = new Player('Christine','any');
var heather = new Player('Heather','any');
var stephani = new Player('Stephani','any');

    //Bond
var matt = new Player('Matt','any');
var christine = new Player('Christine','any');
var patti = new Player('Patti','any');
var bob = new Player('Bob','any')


playerDB = [mattB,mattT,kevin,connor,rhegi,c3po,bender,johnny,matt,christine,heather,stephani,bob,patti];
gameDB = [game1,game2,game3,game4];
...
game2.start();
    ...
    // game3 = new Game('McIsaac');
//game3.addPlayer(matt);
//game3.addPlayer(christine);
game3.addPlayer(heather);
game3.addPlayer(stephani);
game3.start();

    // game4 = new Game('Bond);
game4.addPlayer(matt);
game4.addPlayer(christine);
game4.addPlayer(patti);
game4.addPlayer(bob);
game4.start();
